...
export function Experience({ darkMode }) {
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Designed F&O trading strategies for Nifty & Sensex.",
        "Applied Delta Neutral strategies.",
        "Backtested using Python & Excel.",
        "Delivered trading insights.",
      ],
    },
    {
      role: "Web Developer Intern",
      company: "Corizo",
      tech: "Python, Flask, Django, React.js",
